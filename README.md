...
4. No "Studio" Data Factory em Manage , crie um runtime environment para o seu sistema on-premise(sql server local), baixe o integration runtime e insira a chave fornecida no Integration runtime setup quando o programa pedir, além de adiocionar outras configurações, caso necessário  
...
7. No "Studio" Data Factory em Manage, Crie o linked service para o seu sql database, acione o botão de confiar no certificado, geralmente não consiguirá se conectar sem isso
